							...
							return [4, this.$open({
								...
								content: {
									...
									template: function () {
										...
										return ((0, snabbdom_1.jsx)("div", { class: this.$class('bt-form pd40 ssl-con-box') },
											this.$warningTitle('立即【开启SSL证书】保护面板访问安全'),
											this.$ul({ className: 'explainDescribeList pd15' }, [['访问步骤：'], ['1. 开启https'], ['2. 使用https网站访问面板'], ['3. 如提醒风险（正常现象）点击【高级】或【详情】如下图：'], ['4.【继续访问】或【接收风险并继续】'], [(0, snabbdom_1.jsx)("img", null)]]),
											(0, snabbdom_1.jsx)("div", { class: { pt10: true } },
												this.$line({ title: '类型', width: lineWidth }, this.$select({
													model: 'cert_type',
													width: inputWidth,
													options: [
														{ label: '自签证书 (推荐，自签证书访问会浏览器提示不安全，请放心开启)', value: 1 },
												...
												this.$ul({ className: 'sslSafeTips' }, [[(0, snabbdom_1.jsx)("span", null,
													"\u5F00\u542F\u540E\u5BFC\u81F4\u9762\u677F\u4E0D\u80FD\u8BBF\u95EE\uFF0C\u53EF\u4EE5\u70B9\u51FB\u67E5\u770B",
													this.$link({ title: '解决方法', href: 'https://www.bt.cn/bbs/thread-117246-1-1.html' }))], ['面板SSL是自签证书，不被浏览器信任，显示不安全是正常现象']]))));
									},
									methods: {
								...
								success: function (layers) { return __awaiter(_this, void 0, void 0, function () {
									return __generator(this, function (_a) {
										...
										$('.panel-ssl .explainDescribeList img').attr('title', '点击查看完整图片').attr('src', 'https://www.bt.cn/bbs/data/attachment/forum/202307/28/123048h7vol7vaxnkuqaqa.png').css('width', '218px');
					...
					switch (_a.label) {
						case 0:
							...
							return [4, this.$open({
								...
								btn: ['提交', '取消'],
								content: {
									data: { status_code: parseInt(sessionInfo.statusCode)?parseInt(sessionInfo.statusCode):404 },
									template: function () {
										return ((0, snabbdom_1.jsx)("div", { class: this.$class('pd20 bt-form') },
					...
					switch (_c.label) {
						...
						case 2:
							...
							for (i = 0; i < statusCodeList.length; i++) {
								...
								if(parseInt(sessionInfo.statusCode) === 0){
								    statusCodeTips = '404-页面不存在'
								}
							}
