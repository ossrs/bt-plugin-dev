dynamic.delay('vue-components', () => {
		...
		</div><span v-else class="dir_details_span">
		<a class="btlink path" @click="openPath(title)" href="javascript:;" :title="title">{{title}}</a>
		<div class="dir_details" :data-path="title">
		...
		<pre class="command_output_pre" style="height:450px;" ref="command" >{{command}}</pre></div>`,
                    props: {
                        data: Object,
                    },
                    data: function () {
