...
class firewalls:
    ...
    def AddDropAddress(self,get):
        ...
        if ip_format in  ['0.0.0.0','127.0.0.0',"::1"]: return public.returnMsg(False,'该操作存有风险，已禁止执行!')
        address = get.port
    ...
    def SetPing(self, get):
        ...
        if public.writeFile(filename, conf):
            ...
            return public.returnMsg(False,
                                    '<a style="color:red;">错误：设置失败，sysctl.conf不可写!</a><br>1、如果安装了[宝塔系统加固]，请先关闭<br>2、如果安装了云锁，请关闭[系统加固]功能<br>3、如果安装了安全狗，请关闭[系统防护]功能<br>4、如果使用了其它安全软件，请先卸载<br>')
